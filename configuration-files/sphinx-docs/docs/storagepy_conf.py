...
with open("index.md") as fp:
    for i, line in enumerate(fp):
        if i == 12:
            project = line[:-1].replace(" ","").capitalize()
...
nb_execution_timeout = 600 #-1 # Timeout in seconds
...
show_json_representations = False    # Whether to show json representation of models or settings
show_summaries = True                # Whether to show summaries under models/settings
elaborate_field_info = False         # Whether to list validators and constraints under each field
member_ordering = "bysource"         # How to order summaries, models and settings
ordering = {"summary":{"default":"alphabetical","bysource":"bysource"},"member":{"default":"groupwise","bysource":"bysource"}}
autodoc_pydantic_model_summary_list_order = ordering["summary"][member_ordering]    # ┰─ Ordering
